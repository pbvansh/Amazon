...
const { protect, isSeller, userHavePermission } = require('../middlewares/userMiddl')
...
route.post('/invite', protect, userHavePermission, trimData, requiredField, canInvite, isRole, inviteTeamMember)
